...
public class RecommendationTestRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<Recommendation> recommendations = recommendationService.generateRecommendations(1001L, 1L);

        recommendations
                .forEach(r -> System.out.println("테스트 추천: " + r.getRegionCode() + " -> 정책 코드: " + r.getPolicyCode()));
    }
}